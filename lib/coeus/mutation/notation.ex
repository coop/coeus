defmodule Coeus.Mutation.Notation do
  @moduledoc """
  ...
  defp block_private() do
    ...
    quote do
      private(:coeus, :payload, {:fill, unquote(__MODULE__)})
    end
  end
  ...
  defmacro input(identifier, do: block) do
    [
      ...
      quote do
        private(:coeus, :input, {:fill, unquote(__MODULE__)})
      end,
  ...
  def additional_types(:payload, %Schema.FieldDefinition{identifier: field_ident}) do
    %Schema.ObjectTypeDefinition{
      ...
      module: __MODULE__,
      __private__: [coeus: [payload: {:fill, __MODULE__}]],
  ...
  def add_input_arg(field) do
    ...
    %{
      ...
      | arguments: [arg | field.arguments],
        middleware: [Coeus.Mutation | field.middleware]
    }
  end
end
